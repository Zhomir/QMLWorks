...
ApplicationWindow {
    ...
    property color backgroundColor: "#282c34"  // Dark background color
    property color textColor: "#ffffff"        // White text color
    property color buttonColor: "#3e4451"       // Button color
    property color buttonTextColor: "#ffffff"   // Button text color
    property color leftPanelColor: "#1e2228"   // Darker left panel color
    property color sectionColor: "#3a4049"     // Section color
    property string projectsFilePath: "projects.json" // Path to project file
    ...
    header: Rectangle {
        ...
        Row {
            ...
            // Replaced the Label with SVG logo
            ToolButton {
                anchors.verticalCenter: parent.verticalCenter
                onClicked: {
                ...
                contentItem: Image {
                    ...
                    width: 121.5  // Half of original width to maintain aspect ratio
                    height: 24    // Half of original height to maintain aspect ratio
                }
            }
            ...
            Row {
                ...
                ToolButton {
                    ...
                    height: 40
                    onClicked: {
                        //TODO: Implement open existing project function
                    }
                    background: Rectangle {
                        color: "transparent"
                    }
                    ...
                    ListView {
                        ...
                        delegate: ItemDelegate {
                            ...
                            onClicked: {
                                ...
                                navDrawer.open(); // Open the side menu when project is clicked
    ...
    // Settings Screen (now Title Screen)
    Component {
        id: settingsScreen
        Rectangle {
            color: backgroundColor
    ...
    Component {
        ...
        Rectangle {
            ...
            Column {
                ...
                Image {
                    source: projectData?.storyboard || "placeholder_scene.png"
                    width: 400
                    height: 300
                ...
                Button {
                    text: "Обновить раскадровку"
                    onClicked: if (projectData) projectData.storyboard = "new_scene.png"
                }
            }
        }
    }
    ...
    function getComponent(title) {
        switch (title) {
            ...
            case "Статистика": return projectListScreen // TODO: Create stats component
